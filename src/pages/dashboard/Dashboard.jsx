...
import { FileText, CheckCircle2, DollarSign, Clock, TrendingUp, TrendingDown, Users, Ship, Flag, Calendar, Plus, Building2 } from 'lucide-react'
...
const Dashboard = () => {
    ...
    return (
        <div className="grid grid-cols-1 xl:grid-cols-6 gap-8">
            <div className="space-y-8 pb-12 col-span-1 xl:col-span-4">
...
">
                        ...
                        {(user?.officeId === 1 || import.meta.env.DEV) ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <Link to="/queries/create" className="card p-6 flex flex-col items-center text-center gap-3 hover:border-primary-300 hover:shadow-lg transition-all group">
                                    <div className="p-4 bg-primary-50 rounded-2xl text-primary-600 group-hover:scale-110 transition-transform">
                                        <Plus className="w-8 h-8" />
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-secondary-900">New Query</h4>
                                        <p className="text-xs text-secondary-500 mt-1">Start a new travel lead</p>
                                    </div>
                                </Link>
                                <Link to="/queries" className="card p-6 flex flex-col items-center text-center gap-3 hover:border-blue-300 hover:shadow-lg transition-all group">
                                    <div className="p-4 bg-blue-50 rounded-2xl text-blue-600 group-hover:scale-110 transition-transform">
                                        <FileText className="w-8 h-8" />
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-secondary-900">Manage Queries</h4>
                                        <p className="text-xs text-secondary-500 mt-1">Track and update leads</p>
                                    </div>
                                </Link>
                                <Link to="/masters" className="card p-6 flex flex-col items-center text-center gap-3 hover:border-purple-300 hover:shadow-lg transition-all group">
                                    <div className="p-4 bg-purple-50 rounded-2xl text-purple-600 group-hover:scale-110 transition-transform">
                                        <Building2 className="w-8 h-8" />
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-secondary-900">Master Data</h4>
                                        <p className="text-xs text-secondary-500 mt-1">Suppliers & destinations</p>
                                    </div>
                                </Link>
                            </div>
                        )}
            ...
            <div className='space-y-6 col-span-1 xl:col-span-2'>
                {isRightColLoading ? (
                    ...
                    <>
                        ...
                        {/* Pending Invoices Widget - HQ ONLY */}
                        {user?.officeId === 1 && (
                            <div className="card shadow-md border-0 bg-white rounded-2xl">
